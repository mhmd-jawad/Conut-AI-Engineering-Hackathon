...
INTENT_PATTERNS: dict[str, list[re.Pattern]] = {
    "combo": [
        ...
        re.compile(r"\bproduct\s+combinations?\b", re.I),
        ...
        re.compile(r"\bperform\s+best\b", re.I),
        re.compile(r"\bbest\s+(?:selling|products?|items?)\b", re.I),
        re.compile(r"\b(?:items?|products?)\s+.*\btogether\b", re.I),
        re.compile(r"\btop\s+(?:products?|items?|sellers?)\b", re.I),
        re.compile(r"\bfrequently\s+(?:ordered|purchased|bought)\s+together\b", re.I),
        re.compile(r"\bcombinations?\b", re.I),
    ],
    "forecast": [
